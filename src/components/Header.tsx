            ...
            >
              ...
              <div className="flex gap-2.5">
                <button
                  ...
                  className="flex-1 py-2.5 text-sm font-medium text-gray-600 dark:text-dark-secondary border border-gray-200 dark:border-dark-border rounded-xl hover:bg-gray-50 dark:hover:bg-dark-border/60 transition-colors"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="flex-1 flex items-center justify-center gap-2 py-2.5 text-sm font-semibold bg-gradient-to-r from-brand-600 to-indigo-600 hover:from-brand-700 hover:to-indigo-700 text-white rounded-xl disabled:opacity-40 disabled:cursor-not-allowed transition-all duration-200 shadow-sm hover:shadow-md"
                >
